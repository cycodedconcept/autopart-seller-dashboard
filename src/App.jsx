...
import { getSellerProfile, logout } from './features/authSlice'
import { AUTH_UNAUTHORIZED_EVENT } from './utils/axios'
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<Layout />}>
            ...
            <Route path="/sales/payouts/:id" element={<TransactionDetail />} />
          </Route>
        </Route>
