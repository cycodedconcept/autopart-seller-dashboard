...
const faqCategories = [
  ...
  },
  {
    ...
    questions: [
      { id: 13, question: 'How do I reset my password?', lastUpdated: '2 weeks ago', readingTime: '1 min read', answer: 'Go to the login page and click Forgot Password. Enter your registered email address and follow the instructions sent to your inbox.' },
      { id: 14, question: 'How do I manage API keys?', lastUpdated: '3 weeks ago', readingTime: '2 min read', answer: 'Navigate to Account Settings > Developer to generate, view, and revoke API keys. Keep your keys secure and never share them publicly.' },
    ]
  }
]
    ...
    <div className={`faq-item ${isOpen ? 'open' : ''}`}>
      <button className="faq-question" onClick={() => setIsOpen(!isOpen)} aria-expanded={isOpen}>
        ...
        <div className="faq-question-right">
          <span className="faq-date">Updated {lastUpdated} &middot; {readingTime}</span>
        ...
        <div className="help-hero-content">
          ...
          <div className="help-stat-cards">
            <div className="help-stat-card">
              <div className="help-stat-card-icon"><BookOpen size={20} /></div>
              <div className="help-stat-card-value">50+</div>
              <div className="help-stat-card-label">Help Articles</div>
            </div>
            <div className="help-stat-card">
              <div className="help-stat-card-icon"><FolderOpen size={20} /></div>
              <div className="help-stat-card-value">14</div>
              <div className="help-stat-card-label">Categories</div>
            </div>
            <div className="help-stat-card">
              <div className="help-stat-card-icon"><Clock size={20} /></div>
              <div className="help-stat-card-value">&lt; 4 hrs</div>
              <div className="help-stat-card-label">Avg Response</div>
            </div>
            <div className="help-stat-card">
              <div className="help-stat-card-icon"><Star size={20} /></div>
              <div className="help-stat-card-value">95%</div>
              <div className="help-stat-card-label">Satisfaction</div>
            </div>
          </div>

          <div className="help-topics">
            <span className="help-topics-label">Popular Topics:</span>
            {popularTopics.map(topic => (
              <button key={topic} className={`topic-chip ${activeTopic === topic ? 'active' : ''}`} onClick={() => handleTopicClick(topic)}>
                {topic}
              </button>
            ))}
          </div>
